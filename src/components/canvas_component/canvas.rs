...
use crate::components::{canvas_component::canvas_hook::PropDragNode, node_component::node_hook::PropNodes};

#[component]
pub fn Canvas(nodes: PropNodes, child: Element, is_dark_mode: bool) -> Element {
     let  drag_node = PropDragNode{drag_node_id: use_signal(|| None::<usize>)};
